    ...
    <div class="mx-auto max-w-7xl space-y-6">
        ...
        <div class="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
            @forelse($asignaturas as $asignatura)
                <a href="{{ route('profesor.asignaturas.show', $asignatura->id_asignatura) }}" wire:navigate class="group overflow-hidden rounded-2xl border border-[#d8dee8] bg-white shadow-[0_8px_24px_rgba(16,33,59,0.07)] transition hover:-translate-y-0.5 hover:border-[#c49a35] hover:shadow-lg dark:border-[#2b2b2b] dark:bg-[#2b2b2b]">
                    ...
                    <div class="p-5">
                        ...
                        <div class="mt-4 flex items-center justify-between border-t border-zinc-100 pt-3 text-sm dark:border-[#2b2b2b]">
            ...
            @empty
                <div class="col-span-full rounded-2xl border border-dashed border-zinc-200 bg-white p-10 text-center text-sm text-zinc-500 dark:border-[#2b2b2b] dark:bg-[#2b2b2b]">
