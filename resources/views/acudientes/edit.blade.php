...
<form action="{{ route('acudientes.update', [request()->route('current_team'), $acudiente->id_acudiente ?? $acudiente->id]) }}" method="POST" class="bg-white p-6 rounded-lg shadow space-y-6">
    @csrf
    @method('PUT')
